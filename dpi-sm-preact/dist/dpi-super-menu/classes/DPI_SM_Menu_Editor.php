...
class DPI_SM_Menu_Editor {
  ...
  public function load_assets() {
    wp_register_script( 'dpi-sm-be-js', plugins_url( '/js/backend/app.min.js', realpath( __DIR__ ) ), ['jquery', 'jquery-ui-sortable'], '1.0.0', true );
    wp_register_style( 'dpi-sm-be-css', plugins_url( '/css/backend/main.css', realpath( __DIR__ ) ), null, '1.0.0' );
  ...
  public function render() {
    ...
    wp_localize_script( 'dpi-sm-be-js', 'dpism_localized', $translation );

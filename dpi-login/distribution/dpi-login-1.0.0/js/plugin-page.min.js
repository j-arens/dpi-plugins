...
/***/ function(module, exports, __webpack_require__) {
	...
	var dpiLoginAdmin = function ($, data) {

	    var codemirror = void 0,
	        $colorInputs = void 0,
	        $imageControls = void 0,
	        $editorData = void 0;
	    ...
	    function setImage(data) {
	        var $context = $(data.context.get(0));
	    ...
	    function mediaPicker(context) {
	        if (!state.mediaFrame) {
	            ...
	            state.mediaFrame.on('select', function () {
	                var data = state.mediaFrame.state().get('selection').first().toJSON();
	                setImage({
	                    context: context,
	    ...
	    function handleImageControl(e) {
	        ...
	        var context = $target.closest('.dpi-login-image-container');
	    ...
	    function setCodemirror(data) {
	        codemirror = _codemirror2.default.fromTextArea(document.querySelector('.editor'), {

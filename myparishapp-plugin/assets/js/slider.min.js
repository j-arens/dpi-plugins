...
/***/ (function(module, exports, __webpack_require__) {
	...
	var myParishAppSlider = function (posts) {
	    ...
	    var replace = function replace(state) {
	        ...
	        // slide animate fn
	        var _animateSlide = function _animateSlide(node) {
	        ...
	        // slide markup fn
	        var _generateMarkup = function _generateMarkup(message) {
	        ...
	        // slide render fn
	        var _renderSlide = function _renderSlide(node, idx) {
	        ...
	        return {
	            slide: function slide() {
	                ...
	                state.listItems.forEach(function (item, i) {
	                    setTimeout(function () {
	    ...
	    var query = function query(state) {
	        ...
	        // slice posts fn
	        var _slicePosts = function _slicePosts(begin, end) {
	        ...
	        return {
	            older: function older() {
	                dom.sliderControls.forEach(function (ctrl) {
	                    return ctrl.classList.remove('myparishapp__control-disabled');
	                });
	                var furthestValidSlide = [].concat((0, _toConsumableArray3.default)(state.listItems)).filter(function (item) {
	                    return item.dataset.id !== '';
	                }).pop();
	                var begin = posts.findIndex(function (post) {
	                    return post.ID === parseInt(furthestValidSlide.dataset.id);
	                }) + 1;
	                var end = begin + range;
	            ...
	            newer: function newer() {
	                ...
	                var begin = posts.findIndex(function (post) {
	                    return post.ID === parseInt(state.listItems[0].dataset.id);
	                }) - range;
	                var end = begin + range;
	     ...
	     */
	    var slider = function slider(messages, listItems) {
	        var state = {
	            messages: messages,
	            listItems: listItems
	        };

	        return (0, _assign2.default)({}, state, query(state), replace(state));
	    };
	    ...
	    var bindEvents = function bindEvents() {
	        try {
	            window.addEventListener('resize', (0, _lodash.debounce)(setRange, 50));
	    ...
	    var cacheDom = function cacheDom() {
	        var _dom = dom,
	            root = _dom.root,
	            sliderControls = _dom.sliderControls,
	            sliderUl = _dom.sliderUl,
	            sliderItems = _dom.sliderItems;
	        ...
	        dom = (0, _assign2.default)({ root: root, sliderControls: sliderControls, sliderUl: sliderUl, sliderItems: sliderItems });
	    };
	    ...
	    var ready = function ready() {
	        for (var _len = arguments.length, fnx = Array(_len), _key = 0; _key < _len; _key++) {
	            fnx[_key] = arguments[_key];
	        }

	        if (document.readyState != 'loading') {
	            fnx.forEach(function (fn) {
	                return fn();
	            });
	        } else {
	            document.addEventListener('DOMContentLoaded', function () {
	                return fnx.forEach(function (fn) {
	                    return fn();
	                });
	            });
	        }
